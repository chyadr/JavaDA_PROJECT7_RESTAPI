...
public final class ConstantsTest {
    ...
    public static final BidList bidList= new BidList().bidListId(2).account("account").type("type").bidQuantity(1D).askQuantity(3D).bid(5D).ask(2D).benchmark("benchmark").bidListDate(new Timestamp(System.currentTimeMillis()));
